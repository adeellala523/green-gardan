...
Whether you have a question about a tricky corner of your border, feedback on one of our seasonal guides, or a suggestion for a plant feature, our editorial team is always eager to connect with fellow British gardeners.
...
- Share our articles across social platforms for non-commercial educational purposes.

You may not:
- Systematically scrape, republish full articles, or duplicate our databases without explicit prior written consent.
...
Cookies are small text files placed on your computer or mobile device by websites you visit. They are widely used to ensure websites function properly, operate efficiently, and provide non-identifiable usage statistics to site operators.
...
Essential for website navigation and basic core security features. Without these cookies, the website cannot perform standard functions.

### B. Functional & Preference Cookies

These cookies remember your preferences (such as cookie consent choices or font display modes) to enhance your browsing experience.
...
You can control, disable, or delete cookies through your web browser settings. Please note that disabling essential cookies may impact certain interactive features of the website.
    `
  },
  {
    id: 'page-disclaimer',
...
## 2. Plant Toxicity & Pet Safety Warning

Many popular garden and houseplant species—including, but not limited to, *Digitalis* (Foxglove), *Aconitum* (Monkshood), *Helleborus*, *Euphorbia* sap, and *Lilium* species (extremely toxic to cats)—contain natural toxins that can cause severe illness or death if ingested by humans or domestic pets.

- Always wear protective gloves when handling unfamiliar or sap-producing plants.
- Keep toxic species out of reach of curious children, dogs, and cats.
- Never forage, ingest, or prepare any plant, mushroom, or berry without definitive expert botanical identification.

---

## 3. Physical Safety & Heavy Machinery
