...
export const indoorGardeningArticles: Article[] = [
  {
    ...
    isPopular: true,
    status: 'published',
    seoTitle: 'Best Indoor Plants for Beginners: Tough Houseplant Guide',
    metaDescription: 'Discover the easiest indoor houseplants for UK homes. Resilient, forgiving varieties like Snake Plant, ZZ Plant, and Pothos that thrive with low care.',
    focusKeyword: 'best indoor plants for beginners',
...
3. **Wipe Leaves Regularly:** Household dust, cooking oils, and pet dander coat foliage, blocking stomata. Gently wipe leaves monthly using a soft microfiber cloth dipped in tepid rainwater.
  ...
  },
  {
    ...
    isPopular: false,
    status: 'published',
    seoTitle: 'How to Care for Houseplants in Winter: UK Home Guide',
    metaDescription: 'Essential winter care tips for indoor houseplants in UK homes. Manage central heating dryness, reduced daylight, watering slowdowns, and cold drafts.',
    focusKeyword: 'care for houseplants in winter UK',
...
| **Prayer Plant** | *Maranta leuconeura* | Low-light bookshelves; folds leaves upward at night. |
  ...
  },
  {
    ...
    isPopular: false,
    status: 'published',
    seoTitle: 'How Often to Water Indoor Houseplants: The Foolproof Guide',
    metaDescription: 'Stop killing your houseplants with overwatering. Learn how to tell when your indoor plants actually need water using moisture tests and weight checks.',
    focusKeyword: 'how often water indoor plants',
...
| **Remedy** | Unpot immediately, trim rotten black roots, repot in dry gritty mix. | Soak pot in tepid water basin for 30 minutes until bubbling stops. |
  ...
  },
  {
    ...
    isPopular: false,
    status: 'published',
    seoTitle: 'How to Prevent & Treat Common Houseplant Problems Organically',
    metaDescription: 'Diagnose and cure common indoor plant issues: eradicate fungus gnats, wipe out spider mites, stop brown crispy leaf edges, and prevent root rot.',
    focusKeyword: 'common houseplant problems UK',
...
| **Brown crispy leaf tips on spider plants or calatheas** | Tap water chlorine/fluoride sensitivity or low humidity. | Switch exclusively to collected rainwater or distilled water; group plants together. |
  ...
  },
  {
    ...
    isPopular: false,
    status: 'published',
    seoTitle: 'Creating a Small Indoor Garden at Home: Design & Styling',
    metaDescription: 'Step-by-step inspiration for creating small indoor gardens in UK flats. Plant ladders, closed glass terrariums, and thriving windowsill kitchen herb gardens.',
    focusKeyword: 'small indoor garden at home',
    canonicalUrl: '/indoor-gardening/creating-a-small-indoor-garden-at-home',
    faqs: [
      {
