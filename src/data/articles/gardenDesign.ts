...
export const gardenDesignArticles: Article[] = [
  {
    ...
    isPopular: true,
    status: 'published',
    seoTitle: 'How to Design a Small UK Garden: Clever Layouts & Ideas',
    metaDescription: 'Expert tips on designing small UK gardens and courtyard spaces. Spatial zoning, vertical trellising, mirror illusions, and proportion secrets.',
    focusKeyword: 'how to design a small UK garden',
...
- **Trellis Spacing:** Install horizontal timber battens with 15mm gaps to give contemporary architectural lines while supporting rambling climbing roses and clematis.
  ...
  },
  {
    ...
    isPopular: false,
    status: 'published',
    seoTitle: 'Easy Modern Garden Ideas for UK Homes: Clean & Stylish',
    metaDescription: 'Modern garden design ideas for British properties. Porcelain paving, rendered raised beds, warm architectural lighting, and contemporary plant choices.',
    focusKeyword: 'easy garden ideas for modern homes UK',
