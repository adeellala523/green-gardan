...
export const flowersPlantsArticles: Article[] = [
  {
    id: 'art-7',
    title: 'Best Flowering Plants for UK Gardens: Vibrant All-Summer Blooms',
    ...
    isPopular: true,
    status: 'published',
    seoTitle: 'Best Flowering Plants for UK Gardens: Hardy & Colourful',
    metaDescription: 'Discover the best flowering plants for British gardens. From cottage favourites to long-blooming perennials that withstand unpredictable UK weather.',
    focusKeyword: 'best flowering plants UK gardens',
    canonicalUrl: '/flowers-plants/best-flowering-plants-for-uk-gardens',
    faqs: [
      {
...
3. **The Result:** The uncut stems flower at their normal time in July, while the pruned stems branch outwards and flower 3 to 4 weeks later in late August, effectively doubling your flowering window and creating bushier, sturdier plants.
  ...
  },
  {
    ...
    isPopular: true,
    status: 'published',
    seoTitle: 'Easy-to-Grow Perennials for UK Beginners: 6 Bulletproof Plants',
    metaDescription: 'Discover the easiest perennial flowers for UK beginners. Hardy, slug-resistant, and drought-tolerant varieties that thrive with minimal maintenance.',
    focusKeyword: 'easy perennials for beginners UK',
...
For shady corners where other flowering plants struggle, Brunnera offers large heart-shaped silver leaves with intricate green veins, topped in April and May with clusters of sky-blue forget-me-not blossoms.
  ...
  {
    id: 'art-9',
    title: 'Best Plants for a Sunny Garden: Beating UK Summer Dry Spells',
    ...
    isPopular: false,
    status: 'published',
    seoTitle: 'Best Plants for Sunny UK Gardens: Drought-Tolerant Picks',
    metaDescription: 'Top sun-loving plants for south-facing UK gardens. Drought-resistant perennials, aromatic shrubs, and ornamental grasses that thrive in hot weather.',
    focusKeyword: 'best plants for sunny garden UK',
...
2. **Gravel Mulch:** After planting, top the entire bed with a 5cm layer of clean angular pea shingle or crushed granite. This acts as a barrier against surface evaporation and prevents weed seeds from germinating.
  ...
  {
    id: 'art-10',
    title: 'Best Plants for Shady UK Gardens: Light Up North-Facing Borders',
    slug: 'best-plants-for-shady-uk-gardens',
    categorySlug: 'flowers-plants',
    categoryName: 'Flowers & Plants',
    excerpt: 'Turn dark corners and north-facing fences into lush, textured woodland sanctuaries with ferns, hostas, hellebores, and shade-loving architectural foliage.',
    featuredImage: 'https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?auto=format&fit=crop&w=1200&q=80',
    altText: 'Lush shade garden with glossy hostas, delicate ferns, and dappled woodland sunlight',
    author: defaultAuthor,
    ...
    isPopular: true,
    status: 'published',
    seoTitle: 'Best Plants for Shady UK Gardens: North-Facing Border Guide',
    metaDescription: 'Transform dark, shady UK garden corners. Discover shade-loving perennials, ferns, and woodland flowers that thrive in dry or damp British shade.',
    focusKeyword: 'plants for shady UK gardens',
...
Shady soils, especially beneath mature tree canopies, are frequently starved of organic humus. Generously incorporate leaf mould, peat-free compost, and composted bark every autumn to restore soil moisture retention and microbial activity.
  ...
  },
  {
    ...
    isPopular: false,
    status: 'published',
    seoTitle: 'How to Choose Plants for Your UK Garden Soil Type',
    metaDescription: 'Match the best plants to your UK soil type. Practical guides for heavy clay, dry sandy, chalky alkaline, and acidic peaty British ground.',
    focusKeyword: 'choose plants for garden soil type UK',
    canonicalUrl: '/flowers-plants/how-to-choose-plants-for-your-garden-soil-type-uk',
    faqs: [
      {
...
| **Acid Peaty / Heathland** | 4.5 to 5.5 | *Rhododendron*, *Azalea*, *Calluna* (Heather), *Magnolia*, *Hydrangea* (deep blue). | Calciphiles like wild clematis, hellebores, boxwood. |
  ...
  },
  {
    ...
    isPopular: true,
    status: 'published',
    seoTitle: 'Long-Flowering Plants for British Gardens: May to Autumn',
    metaDescription: 'Discover long-flowering plants that bloom for months in UK gardens. Maximize garden colour with resilient, repeat-blooming varieties.',
    focusKeyword: 'long flowering plants British gardens',
